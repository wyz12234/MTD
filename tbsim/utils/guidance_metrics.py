...
class AdversarialGuidance(GuidanceMetric):
    def __init__(self, scene_idx, params, agents, num_scenes):
        super().__init__(scene_idx, params, agents, num_scenes)
...
class FollowTrajectoryGuidance(GuidanceMetric):
    def __init__(self, scene_idx, params, agents, num_scenes):
        super().__init__(scene_idx, params, agents, num_scenes)
...
class MatchPlannerGuidance(GuidanceMetric):
    def __init__(self, scene_idx, params, agents, num_scenes):
        super().__init__(scene_idx, params, agents, num_scenes)
...
class STRIVEGuidance(GuidanceMetric):
    def __init__(self, scene_idx, params, agents, num_scenes):
        super().__init__(scene_idx, params, agents, num_scenes)
...
GUIDANCE_NAME_TO_METRICS = {
    ...
    'adv_loss': {'adv_loss': AdversarialGuidance},
    'follow_traj': {'follow_traj': FollowTrajectoryGuidance},
    'match_planner': {'match_planner': MatchPlannerGuidance},
    'strive': {'strive': STRIVEGuidance},
}
