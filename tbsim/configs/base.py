...
from configs.query_edit_config import TrainTimeEvaluationConfig
...
class ExperimentConfig(Dict):
    def __init__(
        ...
        self.root_dir = "logs/{}_trained_models/".format(self.algo.name)
        self.seed = 1  # seed for everything (for reproducibility)

        self.devices.devices = 1  # Set to 0 to use CPU
