...
# --- scene-centric ---
from configs.trajdata_nusc_query_config import (
    NuscTrajdataQueryTrainConfig,
    NuscTrajdataQueryEnvConfig
)

from configs.qc_diffuser_config import (
    QueryDiffuserConfig
)
...
EXP_CONFIG_REGISTRY["trajdata_nusc_query"] = ExperimentConfig(
    train_config=NuscTrajdataQueryTrainConfig(),
    env_config=NuscTrajdataQueryEnvConfig(),
    algo_config=QueryDiffuserConfig(),
