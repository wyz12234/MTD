...
class STRIVEConfig(BehaviorCloningConfig):
    def __init__(self):
        ...
        # TODO: tune this
        #       weight schedule?
        self.loss_weights.kl_loss = 4e-3

        self.loss_weights.prediction_loss = 1.0
        self.loss_weights.yaw_reg_loss = 0.01 # 0.1
        self.loss_weights.offroad_loss = 0.1
        self.loss_weights.collision_loss = 0.05
        self.history_num_frames = 30
        self.history_num_frames_ego = 30
        self.history_num_frames_agents = 30
        self.future_num_frames = 52
...
class SceneDiffuserConfig(AlgoConfig):
    def __init__(self):
        ...
        # 边中使用的信息索引对应于(x,y,cos,sin,speed,l,w)或(x,y,cos,sin,velx,vely,l,w,rel_d,rel_d_lw, rel_t_to_collision)
        ...
        # 如果为 True，则所有社会关注层都将涉及交互。 如果为 False，则只有第一个社会关注层会涉及交互。
