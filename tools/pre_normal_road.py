...
def run_scene_editor(eval_cfg, save_cfg, data_to_disk, render_to_video, render_to_img, render_cfg):
    ...
    if data_to_disk and os.path.exists(eval_cfg.experience_train_hdf5_path):
        os.remove(eval_cfg.experience_train_hdf5_path)
    ...
    while scene_i < eval_cfg.num_scenes_to_evaluate:
        ...
        for ei in range(eval_cfg.num_sim_per_scene):
            ...
            if stats["offroad_ego_rate"][-1] < 0.1 and veh_coll == False:
                if eval_cfg.eval_class == "QueryDiffuser":
                    with open('/data/normal_0909.pickle', 'ab') as file:
                ...
                if data_to_disk and "buffer" in info:
                    dump_episode_buffer(
                        ...
                        h5_path=eval_cfg.experience_train_hdf5_path
                    )
...
if __name__ == "__main__":
    ...
    cfg.experience_train_hdf5_path = os.path.join(cfg.results_dir, "train_data.hdf5")
