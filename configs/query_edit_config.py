...
class QueryEditingConfig(EvaluationConfig):
    def __init__(self, registered_name=''):
        super(QueryEditingConfig, self).__init__()
        ...
        self.trajdata.num_sim_per_scene = 1 # 5
        ...
        self.sol_guidance_optimization_params = {
            'optimizer': 'adam', # ignored if video_diff
            'lr': 0.2,
            # Diffuser(20): 1, BC: 8, CVAE(20): 40, BITS(20): 5
            # Diffuser(1): 1, BC: 5, CVAE(1): 40, BITS(20): 1
